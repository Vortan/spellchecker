...
parser.add_argument('--m0', type=float, help="Word itself weight", default=M0)
parser.add_argument('--m1', type=float, help="Edit distance 1 weight", default=M1)
parser.add_argument('--m2', type=float, help="Edit distance 2 weight", default=M2)
parser.add_argument('--mG', type=float, help="Group replacement weight", default=MG)
...
if __name__ == "__main__":
    ...
    print "Using m0=%f m1=%f, m2=%f, mg=%f" % (args.m0, args.m1, args.m2, args.mG)
